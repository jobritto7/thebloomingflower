...
const int TRIG_PIN = 6;              // Arduino pin connected to Light Sensor's TRIG pin - input
const int ECHO_PIN = 7;              // Arduino pin connected to Light Sensor's ECHO pin - output 3
